...
像辩护律师那样说话——每个论点都有支撑句，局限性主动陈述并给出边界，不等被追问。评委三类追问（澄清 / 方法挑战 / 正面质疑）提前演练，包括如何优雅说"我还没有数据支持这一点"。
...
先做时间手术，再动笔。哪张幻灯片合并、哪段跳过一目了然。最难现场即兴的部分——幻灯片之间的交接句——已经写好，不留尴尬停顿的空间。
...
交付的不是线性脚本，是一套模块化论点卡。有开场立场、可乱序调用的分论点、接住其他嘉宾话头的过渡句——让你随时能接话，而不是等轮到自己才开口。
...
先出钩子，再给数字。情绪曲线带着听众走；数字幻灯片放慢讲，背景幻灯片快速过。Q&A 直击最薄弱的那一页——单位经济、护城河，和你最不想被问到的那个问题，都有备好的回答。
